...
const setupLayout = () => {
  ...
  settingsButton.id = 'genui-status-bar-settings-button';
  ...
  `;
  statusBarElement.appendChild(settingsButton);
  ...
  return { genuiContainerElement, iframeElement, statusBarElement, statusBarTextElement };
};
